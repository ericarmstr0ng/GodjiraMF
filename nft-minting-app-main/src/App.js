                ...
                {CONFIG.MARKETPLACE}
							...
							<s.Container jc={"center"} ai={"center"} style={{ width: "80%" }}>
								...
								>
									...
									Mainnet) and the correct address. Please note: Once you make the purchase, you
					...
					{/* <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
						...
						>
							Please make sure you are connected to the right network ({CONFIG.NETWORK.NAME} Mainnet) and
							the correct address. Please note: Once you make the purchase, you cannot undo this action.
						</s.TextDescription>
						<s.SpacerSmall />
						<s.TextDescription
							style={{
						...
						>
							We have set the gas limit to {CONFIG.GAS_LIMIT} for the contract to successfully mint your
							NFT. We recommend that you don't lower the gas limit.
						</s.TextDescription>
					</s.Container> */}
				</s.Container>
				<s.TextTitle
